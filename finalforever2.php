...
move_uploaded_file($target_file,"uploads/");
...
<div style="width: 100%; background-image:url(file:///D:/Project_pics/tU89SSy2.jpg);background-size: cover; height: 500px;margin: 0;padding: 0;">
	...
	<form style="padding-top: 40px" id="form1" enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<div class="container" style="align-content: center;margin: 0 auto;width: 1000px;">
			...
			<div style="width: 100%;height: 210px;background-color: #fff"><img src="file:///D:/Project_pics/logo.jpg" style="width: 200px;height: 200px;padding-top: 10px;padding-bottom: 6px"></div>

			<div><h1 style="font-size:240%;width: 100%;text-align:  center;opacity: 1; background-color: #c0c0c0; text-emphasis-color: #56E7FF; margin: 0;padding-top:20px; padding-bottom: 20px; background-image:url(file:///D:/Project_pics/tU89SSy2.jpg); color:#fff ;background-size: cover;"><b>ROAD ACCIDENT RECORDING FORM </b></h1></div>
			...
			<input type="time" name="Time" style="width: 150px ;padding: 1px;font-size: 13pt;;border: 1px solid black">&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;
			<label style="color:black"><b>3. Date</b></label>&emsp;
			<input type="date" name="Date" style="width:150px;padding: 1px;border: 1px solid black;font-size: 13pt"><br><br>
			</div>
       ...
       <div name="latmoved" id="latmoved" style="display: none"></div>
		...
		<br>
			...
			<div class="cont1" style="text-align: left; width: 1000px;padding: 10px"><table style="width:100%">
				...
				</table><div style="padding-top: 20px;width: 100%"><textarea rows="8" name="remarks" cols="111" placeholder="REMARKS" style="font-size: 12pt;border:solid  #fff"></textarea></div></div></div>
				<label><b>Accident Photos </b></label><br>
				File name:<input type="file" name="file[]" id="file" multiple="multiple"><br>
...
<script type="text/javascript">
  ...
  return $("body").on("keydown", input_types, function(e) {
    ...
    if (e.keyCode === tab_key || e.keyCode === enter_key) {
      ...
      if (e.keyCode === enter_key && (self.prop('type') ==="submit" || self.prop('type') ==="text")) {
        return true;
      }
