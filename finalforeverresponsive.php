    ...
    <form class="form-horizontal" style="padding-top: 40px" id="form1" enctype="multipart/form-data" method="post"
        ...
        <div class="container" style="align-content: center;margin: 0 auto">
            ...
            <fieldset style="width: 100%; background-color:#e5e4e2; margin: 0;padding: 0">
                ...
                <label><br><b>Accident Photos </b></label><br>
                <label>File name:<input type="file" name="file[]" id="file" multiple="multiple"></label><br>
                ...
                <div style = "padding: 10px; padding-bottom: 30px"><button onclick = "buttonfunction()">Print</button><div>
                  <script>
